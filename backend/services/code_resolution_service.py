...
US_HIGH_SCHOOL_COURSE_CONFIG = ResolutionConfig(
    table_name="dict_us_high_school_course",
    primary_key_column="us_high_school_course_id",
    code_column="us_high_school_course_id",
    cn_name_column="course_name_cn",
    en_name_column="course_name_en",
)
...
SUBJECT_RESOLUTION_CONFIGS: dict[str, SubjectResolutionConfig] = {
    ...
    "student_academic_us_high_school_course": SubjectResolutionConfig(
        table_name="student_academic_us_high_school_course",
        id_field="us_high_school_course_id",
        name_field="course_name_text",
        fallback_note_field="notes",
        dictionary=US_HIGH_SCHOOL_COURSE_CONFIG,
        alias_map=_build_alias_map(
            {
                "english 9": "USHS_ENGLISH_09",
                "english 10": "USHS_ENGLISH_10",
                "english 11": "USHS_ENGLISH_11",
                "english 12": "USHS_ENGLISH_12",
                "world literature": "USHS_WORLD_LITERATURE",
                "american literature": "USHS_AMERICAN_LITERATURE",
                "british literature": "USHS_BRITISH_LITERATURE",
                "creative writing": "USHS_CREATIVE_WRITING",
                "journalism": "USHS_JOURNALISM",
                "public speaking": "USHS_PUBLIC_SPEAKING",
                "algebra i": "USHS_ALGEBRA_I",
                "geometry": "USHS_GEOMETRY",
                "algebra ii": "USHS_ALGEBRA_II",
                "precalculus": "USHS_PRECALCULUS",
                "calculus": "USHS_CALCULUS",
                "statistics": "USHS_STATISTICS",
                "biology": "USHS_BIOLOGY",
                "chemistry": "USHS_CHEMISTRY",
                "physics": "USHS_PHYSICS",
                "environmental science": "USHS_ENVIRONMENTAL_SCIENCE",
                "earth science": "USHS_EARTH_SCIENCE",
                "anatomy and physiology": "USHS_ANATOMY_PHYSIOLOGY",
                "world history": "USHS_WORLD_HISTORY",
                "u s history": "USHS_US_HISTORY",
                "us history": "USHS_US_HISTORY",
                "government": "USHS_GOVERNMENT",
                "economics": "USHS_ECONOMICS",
                "geography": "USHS_GEOGRAPHY",
                "psychology": "USHS_PSYCHOLOGY",
                "sociology": "USHS_SOCIOLOGY",
                "human geography": "USHS_HUMAN_GEOGRAPHY",
                "chinese": "USHS_CHINESE",
                "spanish": "USHS_SPANISH",
                "french": "USHS_FRENCH",
                "german": "USHS_GERMAN",
                "japanese": "USHS_JAPANESE",
                "latin": "USHS_LATIN",
                "studio art": "USHS_STUDIO_ART",
                "music": "USHS_MUSIC",
                "theater": "USHS_THEATER",
                "graphic design": "USHS_GRAPHIC_DESIGN",
                "computer science": "USHS_COMPUTER_SCIENCE",
                "programming": "USHS_PROGRAMMING",
                "data science": "USHS_DATA_SCIENCE",
                "web development": "USHS_WEB_DEVELOPMENT",
                "robotics": "USHS_ROBOTICS",
                "cybersecurity": "USHS_CYBERSECURITY",
                "accounting": "USHS_ACCOUNTING",
                "business management": "USHS_BUSINESS_MANAGEMENT",
                "marketing": "USHS_MARKETING",
                "entrepreneurship": "USHS_ENTREPRENEURSHIP",
                "finance": "USHS_FINANCE",
                "business law": "USHS_BUSINESS_LAW",
                "physical education": "USHS_PHYSICAL_EDUCATION",
                "health": "USHS_HEALTH",
                "research seminar": "USHS_RESEARCH_SEMINAR",
                "leadership": "USHS_LEADERSHIP",
                "community service": "USHS_COMMUNITY_SERVICE",
                "study skills": "USHS_STUDY_SKILLS",
                "speech and debate": "USHS_SPEECH_DEBATE",
            }
        ),
    ),
}
