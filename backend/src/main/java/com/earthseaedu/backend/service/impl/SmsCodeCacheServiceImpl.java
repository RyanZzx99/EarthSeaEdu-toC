...
/**
 * SmsCodeCacheServiceImpl 服务实现，承载对应服务接口的业务规则和事务编排。
 */
@Service
public class SmsCodeCacheServiceImpl implements SmsCodeCacheService {
    ...
    /**
     * 创建 SmsCodeCacheServiceImpl 实例。
     */
    public SmsCodeCacheServiceImpl(StringRedisTemplate stringRedisTemplate, EarthSeaProperties properties) {
